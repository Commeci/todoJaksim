...
const uri = `mongodb+srv://commeci:${MONGO_PASS}@cluster0.5qgnm.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0`;
...
app.put("/edit/:id", async (req, res) => {
    ...
    try {
        ...
        if (result.modifiedCount === 1) {
            // 수정 성공 후 상세 페이지로 이동하기 위해 _id를 보내줌
            res.json({
                success: true,
                message: "수정 완료",
                id: _id.toString(),
...
// 서버 종료 시 DB 연결 종료를 추가했습니다
// 0: 정상 종료 - 프로그램이 성공적으로 완료되었음을 나타냄
// process.exit(0);
// 1: 일반적인 오류 - 프로그램이 오류로 인해 종료되었음을 나타냄
// process.exit(1);
// 그 외의 숫자  특정 오류 코드
// process.exit(2);
